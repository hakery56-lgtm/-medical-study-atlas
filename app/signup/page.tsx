...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // 2. Redeem Code immediately on signup
    try {
      ...
      if (!response.ok) {
        // Note: We created the account, but the code was invalid
        // User will be redirected to /redeem if they try to access protected pages
